...
# ``g1_29dof_rev_1_0.usd`` in this directory (``.../config/g1/``).
UNITREE_G1_29DOF_USD_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "g1_29dof_rev_1_0.usd")
...
UNITREE_G1_29DOF_CFG = UnitreeArticulationCfg(
    ...
    spawn=UnitreeUsdFileCfg(
        usd_path=UNITREE_G1_29DOF_USD_PATH,
    ),
